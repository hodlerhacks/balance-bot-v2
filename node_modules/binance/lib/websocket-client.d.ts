...
export declare class WebsocketClient extends EventEmitter {
    ...
    **/
     ...
     */
    subscribeSpotUserDataStreamWithListenKey(listenKey: string, forceNewConnection?: boolean, isReconnecting?: boolean): WebSocket;
    /**
     * Subscribe to spot user data stream - listen key is automatically generated.
     */
    subscribeSpotUserDataStream(forceNewConnection?: boolean, isReconnecting?: boolean): Promise<WebSocket>;
    /**
