...
exports.WebsocketClient = exports.WsConnectionState = void 0;
...
class WebsocketClient extends events_1.EventEmitter {
    constructor(options, logger) {
        ...
        this.restClients = {};
        this.options = Object.assign({ pongTimeout: 2500, pingInterval: 10000, reconnectTimeout: 500 }, options);
    ...
    onWsOpen(ws, wsKey, wsUrl) {
        ...
        this.wsStore.get(wsKey, true).activePingTimer = setInterval(() => this.sendPing(wsKey), this.options.pingInterval);
    }
    ...
    onWsMessage(event, wsKey, source) {
        ...
        try {
            ...
            const eventType = msg.e || (Array.isArray(msg) && ((_a = msg[0]) === null || _a === void 0 ? void 0 : _a.e));
            if (eventType) {
            ...
            this.logger.warning('Unhandled ws message type', Object.assign(Object.assign({}, loggerCategory), { parsedMessage: msg, rawEvent: event, wsKey, source }));
        }
        catch (e) {
    ...
    respawnUserDataStream(market, symbol, isTestnet, respawnAttempt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.logger.warning('User key respawn failed due to error, trying again with short delay', Object.assign(Object.assign({}, loggerCategory), { market, symbol, isTestnet, respawnAttempt, error: e }));
    ...
    subscribeSpotUserDataStream(forceNewConnection, isReconnecting) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.logger.error(`Failed to get spot user data listen key`, Object.assign(Object.assign({}, loggerCategory), { error: e }));
                throw e;
            }
        });
    }
    ...
    subscribeMarginUserDataStream(forceNewConnection, isReconnecting) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.logger.error(`Failed to get margin user data listen key`, Object.assign(Object.assign({}, loggerCategory), { error: e }));
                throw e;
            }
        });
    }
    ...
    subscribeIsolatedMarginUserDataStream(symbol, forceNewConnection, isReconnecting) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.logger.error(`Failed to get isolated margin user data listen key`, Object.assign(Object.assign({}, loggerCategory), { symbol, error: e }));
            }
        });
    }
    /**
    ...
    subscribeUsdFuturesUserDataStream(isTestnet, forceNewConnection, isReconnecting) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.logger.error(`Failed to get USDM Futures user data listen key`, Object.assign(Object.assign({}, loggerCategory), { error: e }));
            }
        });
    }
}
