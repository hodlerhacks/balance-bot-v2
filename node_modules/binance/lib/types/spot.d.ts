...
export declare type DailyAccountSnapshotElement = DailySpotAccountSnapshot | DailyMarginAccountSnapshot | DailyFuturesAccountSnapshot;
...
export declare enum EnumDepositStatus {
    Pending = 0,
    CreditedButCannotWithdraw = 6,
    Success = 1
}
export declare type DepositStatusCode = `${EnumDepositStatus}`;
...
export declare enum EnumWithdrawStatus {
    EmailSent = 0,
    Cancelled = 1,
    AwaitingApproval = 2,
    Rejected = 3,
...
export declare type WithdrawStatusCode = `${EnumWithdrawStatus}`;
...
export declare enum EnumWithdrawTransferType {
    External = 0,
    Interal = 1
}
export declare type WithdrawTransferType = `${EnumWithdrawTransferType}`;
...
export declare type UniversalTransferType = `${EnumUniversalTransferType}`;
...
export declare type APILockTriggerCondition = 'GCR' | 'IFER' | 'UFR';
...
export declare type LoanStatus = 'PENDING' | 'CONFIRMED' | 'FAILED';
...
export declare type IsolatedMarginTransfer = 'SPOT' | 'ISOLATED_MARGIN';
...
export declare type AccountType = 'SPOT' | 'USDT_FUTURE' | 'COIN_FUTURE';
