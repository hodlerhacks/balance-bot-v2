...
class WsStore {
    ...
    isWsConnecting(key) {
        return this.isConnectionState(key, websocket_client_1.WsConnectionState.READY_STATE_CONNECTING)
            || this.isConnectionState(key, websocket_client_1.WsConnectionState.READY_STATE_RECONNECTING);
    }
    /* subscribed topics */
    getTopics(key) {
