...
var typeUtils = require('@analytics/type-utils');
      ...
      return function (action) {
        ...
        if (action.type === EVENTS.bootstrap) {
          ...
          if (initialUser.traits) {
            setItem(USER_TRAITS, objectSpread2(objectSpread2({}, isKnownId && persistedUser.traits ? persistedUser.traits : {}), initialUser.traits));
...
function getUserPropFunc(storage) {
  return function getUserProp(key, instance, payload) {
    ...
    if (payload && typeUtils.isObject(payload) && payload[key]) {
      /*
    ...
    return globalStorageUtils.get(tempKey(key)) || null;
  };
}
      ...
      return function (action) {
        ...
        if (action.type === EVENTS.reset) {
          ...
          [ID, ANONID, 'traits'].forEach(function (key) {
            ...
            globalStorageUtils.remove(tempKey(key));
          });
        }
...
function runCallback(id, payload) {
  if (stack[id] && typeUtils.isFunction(stack[id])) {
    // console.log(`run ${id}`)
    stack[id](payload);
    delete stack[id];
  }
  ...
  if (isOnline && queue && queue.actions && queue.actions.length) {
    ...
    if (pipeline.processIndex && pipeline.processIndex.length) {
      pipeline.processIndex.forEach(function (i) {
        ...
        if (method && typeUtils.isFunction(method)) {
...
function fitlerDisabledPlugins(allPlugins) {
  ...
  return Object.keys(allPlugins).filter(function (name) {
    ...
    if (typeUtils.isBoolean(fromCallOptions[name])) {
    ...
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            pluginObject = typeUtils.isFunction(getPlugins) ? getPlugins() : getPlugins;
                              ...
                              while (1) {
                                switch (_context2.prev = _context2.next) {
                                  ...
                                  case 3:
                                    ...
                                    if (!(!p.method || !typeUtils.isFunction(p.method))) {
                                      _context2.next = 6;
                                      break;
                                    }
                                  ...
                                  case 9:
                                    val = _context2.sent;
                                    returnValue = typeUtils.isObject(val) ? val : {};
...
function shouldAbortAll(_ref5, pluginsCount) {
  ...
  if (!abort) return false;
  if (abort === true || typeUtils.isString(abort)) return true;
...
function formatPayload(action) {
  return Object.keys(action).reduce(function (acc, key) {
    ...
    if (typeUtils.isObject(action[key])) {
...
var getPageData = function getPageData() {
  ...
  if (!typeUtils.isBrowser) return pageData;
...
function getBrowserOS() {
  if (!typeUtils.isBrowser) return false;
...
{
  osName = getBrowserOS();
  referrer = typeUtils.isBrowser ? document.referrer : null;
...
var initialState$3 = {
  ...
  version: null,
  debug: false,
  offline: typeUtils.isBrowser ? !navigator.onLine : false,
  // use node network is-online
  os: {
    name: osName
  },
  userAgent: typeUtils.isBrowser ? navigator.userAgent : 'node',
...
function context() {
  ...
  switch (type) {
    ...
    default:
      if (!initialized) {
        return objectSpread2(objectSpread2(objectSpread2({}, initialState$3), state), {
          initialized: true
        });
      }
...
function Debug() {
  ...
  globalStorageUtils.set(globalVariable, []); // Return debugger
  ...
  return function (createStore$$1) {
    return function (reducer, preloadedState, enhancer) {
      ...
      var dispatch = function dispatch(action) {
        ...
        globalStorageUtils.globalContext[globalVariable].push(a);
...
function ensureArray(singleOrArray) {
  ...
  if (typeUtils.isArray(singleOrArray)) return singleOrArray;
...
function getCallbackFromArgs(argArray) {
  ...
  for (var i = 0; i < args.length; i++) {
    if (typeUtils.isFunction(args[i])) {
      cb = args[i];
      break;
    }
  }
...
function analytics() {
  ...
  var parsedOptions = (config.plugins || []).reduce(function (acc, plugin) {
    if (typeUtils.isFunction(plugin)) {
  ...
  var storage = config.storage ? config.storage : {
    getItem: globalStorageUtils.get,
    setItem: globalStorageUtils.set,
    removeItem: globalStorageUtils.remove
  };
  ...
  var instance = {
    ...
    */
      ...
      regenerator.mark(function _callee(userId, traits, options, callback) {
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                id = typeUtils.isString(userId) ? userId : null;
                data = typeUtils.isObject(userId) ? userId : traits;
                opts = options || {};
                user = instance.user();
                /* sets temporary in memory id. Not to be relied on */

                globalStorageUtils.set(tempKey(ID), id);
      ...
      regenerator.mark(function _callee2(eventName, payload, options, callback) {
        ...
        return regenerator.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                name = typeUtils.isObject(eventName) ? eventName.event : eventName;

                if (!(!name || !typeUtils.isString(name))) {
                  _context2.next = 3;
                  break;
                }
              ...
              case 3:
                data = typeUtils.isObject(eventName) ? eventName : payload || {};
                opts = typeUtils.isObject(options) ? options : {};
      ...
      regenerator.mark(function _callee3(data, options, callback) {
        ...
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                d = typeUtils.isObject(data) ? data : {};
                opts = typeUtils.isObject(options) ? options : {};
                /*
    ...
    on: function on(name, callback) {
      if (!name || !typeUtils.isFunction(callback)) {
        return false;
      }
     ...
     */
    dispatch: function dispatch(action) {
      var actionData = typeUtils.isString(action) ? {
        type: action
      } : action;
  ...
  if (typeUtils.isBrowser && config.debug) {
    ...
    composeWithGlobalDebug = function composeWithGlobalDebug() {
      ...
      if (typeUtils.isObject(_typeof_1(arguments[0]))) return composeWithDebug(arguments[0]);
  ...
  parsedOptions.pluginsArray.map(function (plugin, i) {
    ...
    if (bootstrap && typeUtils.isFunction(bootstrap)) {
      bootstrap({
        instance: instance,
        config: config,
        payload: plugin
